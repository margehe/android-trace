...
def load_shell(bin_path: str, unique_port: bool, verbose: bool,
  ...
  bin_dir = os.path.abspath(os.path.join(os.path.dirname(script_path), os.pardir, os.pardir, os.pardir, os.pardir, os.pardir, 'bin'))
  print("zzb bin_dir: " + bin_dir)
  shell_path = os.path.join(bin_dir, "trace_processor_shell.exe")
  print("zzb shell_path: " + shell_path)
  #assert False, "zzb test"
  if os.name == 'nt' and not shell_path.endswith('.exe'):
    tp_exec = [sys.executable, shell_path]
  else:
    tp_exec = [shell_path]

  print("tp_exec: " + str(tp_exec))
  #exit(0)
